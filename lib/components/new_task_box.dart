...
class NewTaskBox extends StatefulWidget {
  ...
  NewTaskBox({super.key, required this.tasknamecontroller,  required this.descriptioncontroller, required this.datecontroller, required this.timecontroller, required this.oncancel, required this.onsave, required this.dropdownitems, required this.selecteditem});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Container(
        ...
        child: Column(
          children: [
            const Text("Feladat létrehozása",style: TextStyle(color: Colors.white, fontSize: 16)),
            const Align(
            ...
            children: [
              ...
              AddButton(text: "Hozzáadás", onPressed: widget.onsave),
